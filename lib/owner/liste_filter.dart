               ...
               child: Padding(
                 ...
                 child: Column(
                   ...
                   children: [
                     ...
                     //       ),
                     //       child: Center(child: Text("Végétrien",style:
                     //       TextStyle(
                     //           fontSize: 12,
                     //           fontWeight: FontWeight.bold,
                     //           color: Colors.white
                     ...
                     //           color: Color(0xff929292).withOpacity(0.1)
                     //       ),
                     //       child: Center(child: Text("Sans gluten",style:
                     //       TextStyle(
                     //           fontSize: 12,
                     //           fontWeight: FontWeight.bold,
                     //           color: Colors.white
                     ...
                     //           color: Color(0xff929292).withOpacity(0.1)
                     //       ),
                     //       child: Center(child: Text("Sans lactose",style:
                     //       TextStyle(
                     //           fontSize: 12,
                     //           fontWeight: FontWeight.bold,
                     //           color: Colors.white
                     ...
                     //           color: Color(0xff929292).withOpacity(0.1)
                     //       ),
                     //       child: Center(child: Text("Viande",style:
                     //       TextStyle(
                     //           fontSize: 12,
                     //           fontWeight: FontWeight.bold,
                     //           color: Colors.white
                     ...
                     //           color: Color(0xff929292).withOpacity(0.1)
                     //       ),
                     //       child: Center(child: Text("Poisson",style:
                     //       TextStyle(
                     //           fontSize: 12,
                     //           fontWeight: FontWeight.bold,
                     //           color: Colors.white
