...
class DescriptionPageForEdit extends StatefulWidget {
  final FoodEditController controller_foodEditController;

  DescriptionPageForEdit({Key? key, required this.controller_foodEditController}) : super(key: key);

  @override
  State<DescriptionPageForEdit> createState() => _DescriptionPageForEditState();
}

class _DescriptionPageForEditState extends State<DescriptionPageForEdit> {
  TextEditingController descriptionControllar=TextEditingController();

  @override
  void initState() {
    super.initState();
    descriptionControllar.text = widget.controller_foodEditController.foodDescription.value;
  }
            ...
            child: InkWell(
                onTap: () {
                  if(descriptionControllar.text.length > 0) {
                    ...
                    widget.controller_foodEditController.foodDescription.value = descriptionControllar.text;
