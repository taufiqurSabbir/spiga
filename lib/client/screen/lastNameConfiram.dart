...
class LastNameConfirm extends StatefulWidget {
  final ProfileClientController clientController;
  const LastNameConfirm({super.key, required this.clientController});

  @override
  State<LastNameConfirm> createState() => _LastNameConfirmState();
}

class _LastNameConfirmState extends State<LastNameConfirm> {
  ...
  void initState() {
    ...
    super.initState();
    if(widget.clientController.profile.value?.last_name != null) {
      crossClintControllar.text = widget.clientController.profile.value!.last_name!;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    var last_name = widget.clientController.profile.value?.last_name;
                ...
                child: InkWell(
                    onTap: () {
                      ...
                      if(crossClintControllar.text.isEmpty){
                        ...
                        if(widget.clientController.profile.value?.last_name  != crossClintControllar.text){
                          widget.clientController.profile.value?.last_name  = crossClintControllar.text;
