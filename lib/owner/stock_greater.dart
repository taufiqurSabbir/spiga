...
class StockGreaterThan21 extends StatefulWidget {
  final FoodUploadControllerOwner controller_foodUploadController;

  StockGreaterThan21({Key? key, required this.controller_foodUploadController}) : super(key: key);

  @override
  State<StockGreaterThan21> createState() => _StockGreaterThan21State();
}

class _StockGreaterThan21State extends State<StockGreaterThan21> {
            ...
            child: InkWell(
                onTap: () {
                  ...
                  if(crossControllar.text.length > 0) {
                    widget.controller_foodUploadController.foodStock.value = crossControllar.text;
                    Navigator.pop(context);
