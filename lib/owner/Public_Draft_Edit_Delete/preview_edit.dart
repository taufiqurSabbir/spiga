...
class PreviewEdit extends StatefulWidget {
  ...
  PreviewEdit({Key? key, required this.controller_foodEditController}) : super(key: key);

  @override
  State<PreviewEdit> createState() =>
      _PreviewEditState();
}

class _PreviewEditState extends State<PreviewEdit> {
  // List<String> tags=[];
  // List<String> options=[
  ...
  Widget build(BuildContext context) {
    ...
    final hasHtmlTag = RegExp(r'<[^>]*>', multiLine: true, caseSensitive: false).hasMatch(widget.controller_foodEditController.foodDescription.value);
    ...
    return   Obx(()=>
        Scaffold(
          ...
          backgroundColor: bottomShetColor,
          bottomNavigationBar: widget.controller_foodEditController.showLoader.value == false ? Container(
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                    onTap: (){
                      widget.controller_foodEditController.postEditedFoods();
                    },
                    child: Container(
                        height: 54,
                        width: 80.w,
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: (){
                          ...
                          widget.controller_foodEditController.draftEditedFoods();
                        },
                        child: Container(
                            height: 51,
                            width: 38.w,
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: (){
                          ...
                          widget.controller_foodEditController.cancleEditedFoods();
            ...
            child: Column(
              ...
              children: [
                ...
                Visibility(
                  ...
                  children: [
                    ((){
                            ...
                            Padding(
                                ...
                                GestureDetector(
                                    ...
                                    child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color: Color(0xff606060).withOpacity(0.1),
                                            image: DecorationImage(image: FileImage(File(widget.controller_foodEditController.listImageFile.value!.path)),fit: BoxFit.cover))
                                    )
                                )
                            ),
                            SizedBox(height: 15,),
                      ...
                      else if(widget.controller_foodEditController.networkFoodListImage != null && widget.controller_foodEditController.networkFoodListImage.value != widget.controller_foodEditController.networkFoodImage.value){
                        return Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            Padding(
                                ...
                                GestureDetector(
                                    ...
                                    child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color: Color(0xff606060).withOpacity(0.1),
                                            image: DecorationImage(image: NetworkImage(widget.controller_foodEditController.networkFoodListImage.value),fit: BoxFit.cover))
                                    )
                                )
                            ),
                            SizedBox(height: 15,),
                    ...
                    ((){
                            ...
                            Padding(
                                ...
                                GestureDetector(
                                    ...
                                    child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color: Color(0xff606060).withOpacity(0.1),
                                            image: DecorationImage(image: FileImage(File(widget.controller_foodEditController.thumbImageFile.value!.path)),fit: BoxFit.cover))
                                    )
                                )
                            ),
                            SizedBox(height: 15,),
                      ...
                      else if(widget.controller_foodEditController.networkFoodThumbnailImage != null && widget.controller_foodEditController.networkFoodThumbnailImage.value != widget.controller_foodEditController.networkFoodImage.value){
                        return Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            Padding(
                                ...
                                GestureDetector(
                                    ...
                                    child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color: Color(0xff606060).withOpacity(0.1),
                                            image: DecorationImage(image: NetworkImage(widget.controller_foodEditController.networkFoodThumbnailImage.value),fit: BoxFit.cover))
                                    )
                                )
                            ),
                            SizedBox(height: 15,),
                ...
                InkWell(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Padding(
                      ...
                      child: Text("${widget.controller_foodEditController.foodName.value}",
                          style: GoogleFonts.openSans(
                              textStyle: TextStyle(
                                  fontSize: 10.sp,
                                  fontWeight: FontWeight.bold,
                            ...
                            Flexible(
                              child: Column(
                                  children: [
                                    hasHtmlTag
                                        ? Html(
                                      data: "${widget.controller_foodEditController.foodDescription.value}",
                                      style: {
                                        "*": Style(
                                        ...
                                        : Text('${widget.controller_foodEditController.foodDescription.value}',
                                        style: GoogleFonts.openSans(
                                            textStyle: TextStyle(
                                                fontSize: 10.sp,
                                                fontWeight: FontWeight.bold,
                  ...
                  trailing: Wrap(
                    children:<Widget> [
                      Container(
                        ...
                        child: Center(child: Text("${widget.controller_foodEditController.foodStock.value}",
                            style: GoogleFonts.openSans(
                                textStyle: TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.bold,
                ...
                ListTile(
                  ...
                  trailing: Wrap(
                    children:<Widget> [
                      Text("${HelperFunction.stringToCurrency(widget.controller_foodEditController.foodDiscountPricePrix.value, "€ ")}",
                          style: GoogleFonts.openSans(
                              textStyle: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.bold,
                ...
                ListTile(
                  ...
                  trailing: Wrap(
                    children:<Widget> [
                      Text("${HelperFunction.stringToCurrency(widget.controller_foodEditController.foodPricePrix.value, "€ ")}",
                          style: GoogleFonts.openSans(
                              textStyle: TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: TextButton(
                            style: ButtonStyle(
                                backgroundColor: DateTime.parse(widget.controller_foodEditController.pickUpDate.value).isAtSameMomentAs(DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day))
                                    ? MaterialStateProperty.all(mainTextColor)
                                    : MaterialStateProperty.all(Colors.transparent),
                                side: MaterialStatePropertyAll(
                                    BorderSide(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: null,
                                    child: Text(
                                      "${HelperFunction.getTodayTomorrowOrDateWithYear(widget.controller_foodEditController.pickUpDate.value.toString())}",
                                      style: GoogleFonts.openSans(
                                        textStyle: TextStyle(
                                          fontSize: 12,
                                          fontWeight: FontWeight.bold,
                        ...
                        child: TextButton(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 10),
                                Text("${widget.controller_foodEditController.pickUpTimeFrom.value!}",
                                    style: GoogleFonts.openSans(
                                        textStyle: TextStyle(
                                            fontSize: 12,
                                            fontWeight: FontWeight.bold,
                        ...
                        child: TextButton(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 10),
                                Text("${widget.controller_foodEditController.pickUpTimeTo.value!}",
                                    style: GoogleFonts.openSans(
                                        textStyle: TextStyle(
                                            fontSize: 12,
                                            fontWeight: FontWeight.bold,
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16),
                  child: Column(
                      children: getFoodCatColumn(widget.controller_foodEditController.foodCatArray)
  ...
  getFoodCatColumn(RxList<FoodCat.Data> catTypeArray){
    List<FoodCat.Data> catArray = widget.controller_foodEditController.catTags.value;
    ...
    catArray.forEach((FoodCat.Data cat)
    {
      allergy_count++;
  ...
  getAllergyColumn( ){
    ...
    List<Allergy> allergyArray = widget.controller_foodEditController.tags.value;
