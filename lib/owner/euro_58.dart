...
class Euro_58 extends StatefulWidget {
  final FoodUploadControllerOwner controller_foodUploadController;

   Euro_58({Key? key, required this.controller_foodUploadController}) : super(key: key);

  @override
  State<Euro_58> createState() => _Euro_58State();
}

class _Euro_58State extends State<Euro_58> {
  TextEditingController crossControllar=TextEditingController();
  TextEditingController crossControllar2=TextEditingController();

  @override
  void initState() {
    if(widget.controller_foodUploadController.foodDiscountPricePrix.value != ""){
      crossControllar2.text = widget.controller_foodUploadController.foodDiscountPricePrix.value;
    }

    if(widget.controller_foodUploadController.foodPricePrix.value != ""){
      crossControllar.text = widget.controller_foodUploadController.foodPricePrix.value;
    }
  }
            ...
            child: InkWell(
                onTap: () {
                  ...
                  if(crossControllar2.text.length > 0) {
                    widget.controller_foodUploadController.foodDiscountPricePrix.value = crossControllar2.text;
                  }
                  else{
                  ...
                  if(crossControllar.text.length > 0) {
                    widget.controller_foodUploadController.foodPricePrix.value = crossControllar.text;
