...
class TitreDeLoffrePage extends StatefulWidget {
  final FoodUploadControllerOwner controller_foodUploadController;

  TitreDeLoffrePage({Key? key, required this.controller_foodUploadController}) : super(key: key);

  @override
  State<TitreDeLoffrePage> createState() => _TitreDeLoffrePageState();
}

class _TitreDeLoffrePageState extends State<TitreDeLoffrePage> {
  TextEditingController crossControllar=TextEditingController();

  @override
  void initState() {
    if(widget.controller_foodUploadController.foodName.value != ""){
      crossControllar.text = widget.controller_foodUploadController.foodName.value;
    }
  }
            ...
            child: InkWell(
                onTap: () {
                  ...
                  if(crossControllar.text.length > 0) {
                    widget.controller_foodUploadController.foodName.value = crossControllar.text;
