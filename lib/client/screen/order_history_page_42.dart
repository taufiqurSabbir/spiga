                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(left: 10),
                                        child: Text("${HelperFunction.stringToCurrency(orderHistoryClientController.orders[index].totalPrice.toString(), "€")}",
                                            style: GoogleFonts.openSans(
                                                textStyle: TextStyle(
                                                    fontSize: 12.sp,
                                                    fontWeight:
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color:(orderHistoryClientController.orders[index].orderStatus  == 1)? statusColorNew:(orderHistoryClientController.orders[index].orderStatus  == 2)? statusColorprocess:(orderHistoryClientController.orders[index].orderStatus  == 3)? statusColorReady :(orderHistoryClientController.orders[index].orderStatus  == 4)? statusColordelivered: (orderHistoryClientController.orders[index].orderStatus  == 5)? statusColorRefunded : (orderHistoryClientController.orders[index].orderStatus  == 6)? statusColorCancle : Colors.red,
                                    ),
                                    child: Center(
